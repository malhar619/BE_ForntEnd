...
const SmallCapHome = () => {
  ...
  return (
    ...
    <div className="p-6 text-white min-h-screen">
      <h2 className="text-4xl text-green-400 font-bold mb-8">Small Cap Equity Funds</h2>
      ...
      <h3 className="text-2xl text-green-400 font-bold mt-8 mb-4">All Small Cap Equity Funds Data and Returns</h3>
