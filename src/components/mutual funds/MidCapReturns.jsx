  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        console.error(`Error fetching mid cap returns data for ${type} returns:`, error);
      }
    };
  ...
  return (
    ...
    <div className="p-6 min-h-screen">
      <h2 className="text-4xl text-green-400 font-bold mb-8">
        Mid Cap Equity Funds based on {type === '1Y' ? '1 Year' : type === '3Y' ? '3 Year' : type === '5Y' ? '5 Year' : type === '10Y' ? '10 Year' : 'Unknown'} Returns
      </h2>
